...
from ui.bootloader import build_firmware_upload_card
from ui.header import build_can_config_fields, build_theme_button
from ui.dashboard_tab import build_time_window_controls
...
DEFAULT_BITRATE   = int(sys.argv[3]) if len(sys.argv) > 3 else 125000
...
_TAB_STYLE = {
    ...
    "border": "1px solid var(--border)", "padding": "6px 16px", "fontSize": "13px",
}
_TAB_SELECTED = {
    "background": "var(--bg-card)", "color": "var(--accent)",
    "borderTop": "2px solid var(--accent)", "border": "1px solid var(--border)",
...
app.layout = html.Div(
    style={"fontFamily": "'Inter', 'Segoe UI', sans-serif",
           "background": "var(--bg-page)", "minHeight": "100vh", "padding": "14px 24px",
           "maxWidth": "1300px", "margin": "0 auto", "color": "var(--text)"},
    children=[
        ...
        html.Div(
            ...
            children=[
                html.H2("EAuto Live Dashboard",
                        style={"margin": "0", "fontSize": "16px", "color": "var(--text)",
        ...
        dcc.Tabs(
            ...
            colors={"border": "var(--border)", "primary": "var(--accent)", "background": "var(--bg-page)"},
            children=[
                dcc.Tab(
                    label="Dashboard",
                    value="tab_dashboard",
